...
# Dynamically add the System directory to the system path
system_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'System'))
sys.path.append(system_path)

try:
    from version import __version__  # Import __version__ from version.py
...
class TerminalApp:
    def __init__(self, root):
        ...
        icon_path = "ShellOS/System69/resources/icons/terminal.ico"
        ...
        self.prompt = f"ShellOS@{device_name}>"
    ...
    def sysfetch(self):
        ...
        self.terminal.insert(tk.END, f"Name: ShellOS\n")
        self.terminal.insert(tk.END, f"Version: {__version__}\n")
